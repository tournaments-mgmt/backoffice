    ...
    <TransitionContainer transition="left">
      ...
      >
        <div
          ...
          :key="i"
        >
          <div v-for="(entrant, index) of entrantList[i - 1]" :key="index">
            <EntrantItem
              :key="index"
              :name="entrant.name"
              :color="entrant.color"
...
import EntrantItem from "@/components/EntrantItem/EntrantItem.vue";

let viewInterval: any;
const TournamentEntrantsList = defineComponent({
  components: {
    EntrantItem,
    TransitionContainer,
  },
...
export default TournamentEntrantsList;
</script>
